...
export interface UserContextType {
  ...
  fetchLeaderboardUsers: (lastVisible?: DocumentSnapshot<DocumentData, DocumentData>) => Promise<{ users: User[], lastVisible?: DocumentSnapshot<DocumentData> }>;
  ...
  const purchaseShopItem = useCallback(async (shopId: string, itemId: string, buyerUserId: string, buyerCharacterId: string, quantity: number) => {
            ...
            if (item.inventoryTag === 'проживание') {
                ...
                if (existingItemIndex > -1) {
                    ...
                    const newInventoryItem: InventoryItem = {
                        ...
                        artifactHasDamage: item.artifactHasDamage,
                        artifactHasHealing: item.artifactHasHealing,
                        artifactHasMana: item.artifactHasMana,
    ...
    const adminGiveItemToCharacter = useCallback(async (userId: string, characterId: string, itemData: AdminGiveItemForm) => {
        ...
        const newInventoryItem: InventoryItem = {
            ...
            inventoryTag: itemData.inventoryTag,
            ...
            artifactHasDamage: itemData.artifactHasDamage,
            artifactHasHealing: itemData.artifactHasHealing,
            artifactHasMana: itemData.artifactHasMana,
