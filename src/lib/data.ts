...
export const ALL_ACHIEVEMENTS: Achievement[] = [
  ...
  { id: 'ach-pumpkin-spouse', name: 'Тыквенный(ая) супруг(а)', description: 'Получение Тыкво-Жены.', iconName: 'Heart' },
  { id: 'ach-unique-character', name: 'Владелец уникального персонажа', description: 'Покупка закрытой расы.', iconName: 'VenetianMask' },
  { id: 'ach-multi-hand', name: 'Многоручка', description: 'Покупка доп. персонажа.', iconName: 'Users' },
  { id: 'ach-tamer', name: 'Укротитель', description: 'Приручение дикого питомца.', iconName: 'Cat' },
  { id: 'ach-mafiosi', name: 'Мафиози', description: 'Наличие связей в криминале.', iconName: 'KeyRound' },
  { id: 'ach-submariner', name: 'Люблю подводный мир', description: 'Дружба с Левиафаном.', iconName: 'Anchor' },
  { id: 'ach-seaman', name: 'Мореход', description: 'Владение судном.', iconName: 'Ship' },
  { id: 'ach-sky-master', name: 'Освоил небо', description: 'Владение дирижаблем.', iconName: 'Rocket' },
  { id: 'ach-big-mage', name: 'Большой, большой!', description: 'Покупка большого маг. резерва.', iconName: 'Flame' },
  { id: 'ach-important-person', name: 'Важный', description: 'Высокая должность при дворе.', iconName: 'Crown' },
  { id: 'ach-baron', name: 'Ваша Милость', description: 'Получение титула Барона.', iconName: 'ChessKing' },
  { id: 'ach-sir-lady', name: 'Сэр/Леди', description: 'Получение придворного титула.', iconName: 'Award' },
  { id: 'ach-warlock', name: 'Колдун', description: 'Получение доп. стихии.', iconName: 'Waves' },
  { id: 'ach-wizard', name: 'Чародей', description: 'Получение доп. учения.', iconName: 'BookPlus' },
  { id: 'ach-guildmaster', name: 'Гильдмастер', description: 'Основание собственной гильдии.', iconName: 'Building2' },
  { id: 'ach-hybrid', name: 'Гибридная полукровка', description: 'Создание персонажа-полукровки.', iconName: 'Combine' },
  { id: 'ach-exchange-master', name: 'Мастер обмена', description: 'Обмен стихии на учение.', iconName: 'Replace' },
  { id: 'ach-dark-lord', name: 'Тёмный Владыка', description: 'Получение запретной магии.', iconName: 'Skull' },
  { id: 'ach-chimera-mancer', name: 'Химеромант', description: 'Радикальное изменение тела.', iconName: 'GitBranchPlus' },

  // Manual
  { id: 'ach-ruler', name: 'Правитель государства', description: 'Несёт бремя правления в Триаде.', iconName: 'ShieldCheck' },
  { id: 'ach-august-family', name: 'Из семьи августейших особ', description: 'Связан узами с правителем.', iconName: 'Users' },
  { id: 'ach-your-grace', name: 'Ваша Светлость', description: 'Второй по важности землевладелец.', iconName: 'Landmark' },
  { id: 'ach-your-excellency', name: 'Ваше Сиятельство', description: 'Третий по важности землевладелец.', iconName: 'Landmark' },
  { id: 'ach-event-master', name: 'Мастер ивентов', description: 'За проведение интересных ивентов.', iconName: 'PartyPopper' },
  { id: 'ach-light-god-watch', name: 'Светлый Бог следит за вами', description: 'Вы заинтересовали Светлого Бога.', iconName: 'Sun' },
  { id: 'ach-dark-god-watch', name: 'Тёмный Бог следит за вами', description: 'Вы заинтересовали Тёмного Бога.', iconName: 'Moon' },
  { id: 'ach-unknown-goddess-watch', name: 'Богиня следит за вами', description: 'Вы заинтересовали Неизвестную Богиню.', iconName: 'Sparkles' },
  { id: 'ach-demigod-watch', name: 'Полубоги заинтересованы', description: 'Вы заинтересовали Полубогов.', iconName: 'Star' },
  { id: 'ach-saturn-watch', name: 'Сатур следит за вами', description: 'Не скрыться от папарацци.', iconName: 'Eye' },
  { id: 'ach-newspaper-regular', name: 'Завсегдатай газет', description: 'Покупка 10+ статей в газете.', iconName: 'Newspaper' },
  { id: 'ach-landless', name: 'Безземельный', description: 'Пятый брат троюродного соседа.', iconName: 'Home' },
