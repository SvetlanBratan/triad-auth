...
export const RACE_OPTIONS: OptionType[] = [
    ...
    { value: 'Антропоморф', label: 'Антропоморф' },
    { value: 'Арахния', label: 'Арахния' },
    { value: 'Арахнид', label: 'Арахнид' },
    { value: 'Аспид', label: 'Аспид' },
    { value: 'Астролоид', label: 'Астролоид' },
    { value: 'Бабочка', label: 'Бабочка' },
    { value: 'Безликий', label: 'Безликий' },
    { value: 'Белояр', label: 'Белояр' },
    { value: 'Бракованный пересмешник', label: 'Бракованный пересмешник' },
    { value: 'Вампир', label: 'Вампир' },
    { value: 'Вансаэлец', label: 'Вансаэлец' },
    { value: 'Василиск', label: 'Василиск' },
    { value: 'Весп', label: 'Весп' },
    { value: 'Вулгар', label: 'Вулгар' },
    { value: 'Гибридный вампир', label: 'Гибридный вампир' },
    { value: 'Гурит', label: 'Гурит' },
    { value: 'Дарнатиар', label: 'Дарнатиар' },
    { value: 'Джакали', label: 'Джакали' },
    { value: 'Джинн', label: 'Джинн' },
    { value: 'Домовой', label: 'Домовой' },
    { value: 'Дракон', label: 'Дракон' },
    { value: 'Дриада', label: 'Дриада' },
    { value: 'Дрид', label: 'Дрид' },
    { value: 'Дроу', label: 'Дроу' },
    { value: 'Инсектоид', label: 'Инсектоид' },
    ...
    { value: 'Кунари', label: 'Кунари' },
    { value: 'Ларим', label: 'Ларим' },
    { value: 'Лартист', label: 'Лартист' },
    { value: 'Лепрекон', label: 'Лепрекон' },
    { value: 'Миканид', label: 'Миканид' },
    { value: 'Мириод', label: 'Мириод' },
    { value: 'Нарратор', label: 'Нарратор' },
    { value: 'Неземной', label: 'Неземной' },
    ...
    { value: 'Полузай', label: 'Полузай' },
    { value: 'Проклятый', label: 'Проклятый' },
    { value: 'Псилат', label: 'Псилат' },
    { value: 'Рарит', label: 'Рарит' },
    { value: 'Саламандра', label: 'Саламандра' },
    { value: 'Светоликий', label: 'Светоликий' },
    { value: 'Сирена', label: 'Сирена' },
    { value: 'Слизень', label: 'Слизень' },
    { value: 'Снежный эльф', label: 'Снежный эльф' },
    { value: 'Солнечный эльф', label: 'Солнечный эльф' },
    { value: 'Сфинкс', label: 'Сфинкс' },
    { value: 'Тальен', label: 'Тальен' },
    { value: 'Тень', label: 'Тень' },
    { value: 'Тритон', label: 'Тритон' },
    { value: 'Хамелеон', label: 'Хамелеон' },
    { value: 'Химера', label: 'Химера' },
    { value: 'Цынар', label: 'Цынар' },
    { value: 'Энергетический вампир', label: 'Энергетический вампир' },
    { value: 'Ятанаги', label: 'Ятанаги' },
    { value: 'Кукла', label: 'Кукла' },
    { value: 'Призрак', label: 'Призрак' },
    { value: 'Дух', label: 'Дух' },
...
export const PHYSICAL_TRAINING_OPTIONS: OptionType[] = [
    { value: 'Низкий (начальный)', label: 'Низкий (начальный)' },
    { value: 'Средний (общефизическая подготовленность)', label: 'Средний (общефизическая подготовленность)' },
    { value: 'Высокий (специальная подготовленность)', label: 'Высокий (специальная подготовленность)' },
    { value: 'Высший (спортивное долголетие)', label: 'Высший (спортивное долголетие)' },
];
...
export const rewards: Reward[] = [
    ...
    { id: 'r-extra-char', title: 'Дополнительный персонаж', description: 'Бесплатно доступно 6 слотов персонажей. Для 7-го и следующих нужно купить эту награду.', cost: 1000, type: 'permanent', iconName: 'UserRoundPlus' },
