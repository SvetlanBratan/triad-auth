...
const inventoryLayout: {
...
}[] = [
    {
        ...
        categories: [
            ...
            { key: 'ингредиенты', label: 'Ингредиенты', icon: FlaskConical },
