    ...
    <main className="flex min-h-screen flex-col items-center p-4 md:p-8">
      <div className="w-full max-w-7xl space-y-6">
        <div className="relative w-full h-40 md:h-56 rounded-lg overflow-hidden">
            ...
            <header className="absolute inset-0 w-full p-4 md:p-6 flex flex-col justify-end md:justify-end md:flex-row md:items-end gap-4">
                ...
                <div className="flex items-center gap-2 bg-background/60 backdrop-blur-sm p-2 rounded-md self-end">
                    <UserSwitcher />
                    <ThemeToggle />
                </div>
            </header>
