...
export default function CharacterPage() {
    ...
    const age = character.birthDate ? calculateAge(character.birthDate, new Date()) : null;
                                ...
                                <TooltipProvider>
                                    <Tooltip>
                                        <TooltipTrigger asChild>
                                            <Button variant="ghost" size="icon" className="h-6 w-6" onClick={() => setEditingState({ type: 'field', section: 'mainInfo', field: 'race' })}>
