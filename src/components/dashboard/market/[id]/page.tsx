                            ...
                            <div className="space-y-4 p-4 border rounded-md">
                                <h4 className="font-semibold mb-2">Настройки магазина</h4>
                                 <div className="flex items-center space-x-2 my-2">
                                    <Switch id="use-image-url-switch" checked={useImageUrl} onCheckedChange={setUseImageUrl} />
                                    <Label htmlFor="use-image-url-switch">Вставить ссылку на изображение</Label>
                                </div>
                                {useImageUrl ? (
                                     <div className="space-y-2">
                                        <Label htmlFor="shopImage">URL изображения</Label>
                                        <Input id="shopImage" value={editedImage} onChange={(e) => setEditedImage(e.target.value)} />
                                    </div>
                                ) : (
                                    <div>
